...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.querySelector('.settings-nav-item[data-tab]')) setupSettingsNav();
});
...
function setupThemeToggle() {
    ...
    updateSubtitle(); // Set initial subtitle
...
function switchTab(tabName) {
    ...
    // Highlight the matching nav item via its data-tab attribute
...
/**
 * Wire up settings nav items using data-tab attributes.
 * Called via DOMContentLoaded — avoids all inline onclick handlers
 * which are blocked by the Content Security Policy.
 */
