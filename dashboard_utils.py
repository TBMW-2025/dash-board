        ...
        <div class="sidebar">
            <div class="sidebar-top">
                ...
                <nav class="sidebar-nav">
                    <a href="index.html" class="nav-item {active_index}">
            ...
            <div class="sidebar-bottom">
                ...
                <div class="user-profile" onclick="safeRedirect('login.html')">
...
def update_sidebars():
    """Replaces sidebars in all HTML files (except login.html) with current template."""
    for file in os.listdir('.'):
        if not file.endswith('.html') or file == 'login.html':
            continue
        with open(file, 'r') as f:
            content = f.read()

        active = {
            'active_index': 'active' if file == 'index.html' else '',
